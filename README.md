...
Telegram-бот-репетитор английского: пользователь **пишет** или **говорит** по-английски, бот проверяет фразу, объясняет ошибки на русском и ведёт диалог. На голосовое отвечает голосом. Плюс **структурированные мини-уроки** по одной теме: новые слова, грамматика и задания (`/lesson`).
...
Покрыты: парсеры JSON-ответа LLM (практика и уроки), сервисы практики и уроков (на мок-модели), навигация по шагам урока, SQLite-хранилище и статистика, форматтеры, конвертация аудио через ffmpeg.
...
- [ ] **Фазы 2–7** — темы/вопросы, определение уровня (A1–C1), память пользователя, заметки после уроков, адаптивное обучение, интересы
- [ ] **Фазы 8–12** — AI-персонажи, удержание, прогресс, напоминания, игровые элементы
